...
public class TableColumn<RowT> internal constructor(
    ...
    public val alignment: TableAlignment? = null,
    public val padding: TablePadding? = null,
    public val value: (RowT) -> String,
    public val cellRenderer: TableCellRenderer<RowT>? = null,
    public val headerRenderer: TableHeaderRenderer<RowT>? = null,
    public val editHandler: TableEditHandler<RowT>? = null,
...
public class TableStyle internal constructor(
    ...
    internal val paddingExplicit: Boolean = false,
