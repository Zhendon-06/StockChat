...
/** Displays an Android/JVM Excel [File] directly and handles asynchronous loading internally. */
...
/** [KuiklyTable] overload that accepts and displays an Android/JVM Excel [File] directly. */
